    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.getcurrentloc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fusedLocationClient = LocationServices.getFusedLocationProviderClient(Advert.this);
                geocoder = new Geocoder(Advert.this, Locale.getDefault());

                if (ActivityCompat.checkSelfPermission(Advert.this, Manifest.permission.ACCESS_FINE_LOCATION)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Advert.this,
